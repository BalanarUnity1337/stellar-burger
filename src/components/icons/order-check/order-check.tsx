...
export const OrderCheck = (): React.JSX.Element => {
  return (
    <svg
      width="107"
      height="102"
    ...
    >
      <path
        className={`${styles.shape_animation_medium}`}
        fillRule="evenodd"
        clipRule="evenodd"
        ...
        fill="url(#paint0_radial_724_425)"
        fillOpacity="0.25"
      />
      <path
        className={`${styles.shape_animation_large}`}
        fillRule="evenodd"
        clipRule="evenodd"
        ...
        fill="url(#paint1_radial_724_425)"
        fillOpacity="0.25"
      />
      <path
        className={`${styles.shape_animation_small}`}
        fillRule="evenodd"
        clipRule="evenodd"
        ...
        fill="url(#paint2_radial_724_425)"
        fillOpacity="0.25"
      />
      <path
        fillRule="evenodd"
      ...
      <defs>
        <radialGradient
          id="paint0_radial_724_425"
          cx="0"
          cy="0"
          r="1"
          gradientTransform="matrix(49 -51 24.7783 51 53 51)"
        ...
        <radialGradient
          id="paint1_radial_724_425"
          cx="0"
          cy="0"
          r="1"
          gradientTransform="matrix(53.5 -50 27.0538 50 53.5 51)"
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#801AB3" stopOpacity="0" />
          <stop offset="1" stopColor="#4C4CFF" />
        ...
        <radialGradient
          id="paint2_radial_724_425"
          cx="0"
          cy="0"
          r="1"
          gradientTransform="matrix(-34 32.6667 34 16.5189 53 50.6667)"
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#801AB3" stopOpacity="0" />
